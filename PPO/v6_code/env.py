...
class HunterPreyEnv:
    ...
    def __init__(
        ...
        # Anti-wall-camping (v4 → v5: stronger, corner-aware)
        self.R_WALL_PREY  =  -0.05    # penalty at edge (50% of heading)
        self.R_CORNER_PREY=  -0.05    # ADDITIONAL penalty in corners (both axes near wall)
        self.WALL_EDGE    =  30.0     # pixels — wider zone gives more warning
