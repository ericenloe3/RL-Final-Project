...
The same env, curriculum, and asymmetric training from PPO carry over:
  ...
  - Hunter freeze (first 20% of training)
  - Larger prey network (192 vs 128 hidden)
...
# Target entropy = -dim(action) is standard for SAC
TARGET_ENTROPY    = {"hunter": -2.0, "prey": -1.0}  # prey gets higher entropy target
